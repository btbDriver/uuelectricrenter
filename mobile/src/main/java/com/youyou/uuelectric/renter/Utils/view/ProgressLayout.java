...
public class ProgressLayout extends RelativeLayout {
    ...
    public void showError(View.OnClickListener onClickListener, String errorMessage, String button) {
    ...
    public void showErrorSmall(View.OnClickListener onClickListener, String errorMessage, String button) {
        this.errorMessage = errorMessage;
        this.errorButton = button;
        switchState(State.ERROR_SMALL, onClickListener);
    }
