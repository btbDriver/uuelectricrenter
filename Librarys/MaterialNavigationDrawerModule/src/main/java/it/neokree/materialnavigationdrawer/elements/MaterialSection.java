...
public class MaterialSection<Fragment> implements View.OnTouchListener, View.OnClickListener {
     ...
     * 通知红点
     */
    private TextView notificationPoint;
    /**
     * 描述
     */
    ...
    public MaterialSection(Context ctx, int iconType, boolean hasRippleSupport, int target) {
        ...
        notificationPoint = (TextView) view.findViewById(R.id.section_notification_point);
        desc = (TextView) view.findViewById(R.id.section_desc);
     ...
     * @return
     */
    public MaterialSection setNotificationReadPointVisible(boolean isVisible) {
        if (notificationPoint != null) {
            if (isVisible) {
                notificationPoint.setVisibility(View.VISIBLE);
            } else {
                notificationPoint.setVisibility(View.INVISIBLE);
            }
        }
        return this;
    }
     ...
     * @return
     */
    public boolean notificationReadPointIsShowing() {
        if (notificationPoint != null) {
            if (notificationPoint.getVisibility() == View.VISIBLE) {
                return true;
            }
        }
        return false;
     ...
     * @return
     */
    public MaterialSection setSectionDesc(String text) {
        if (desc != null) {
