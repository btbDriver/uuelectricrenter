...
public class WheelView extends View {
    ...
    // Wheel drawables
    private int wheelBackground = R.drawable.wheel_bg_white;
    private int wheelForeground = R.drawable.wheel_val_white;
    ...
    private void drawShadows(Canvas canvas) {
        int height = (int) (shadowNum * getItemHeight());
     ...
     * @param num
     */
    public void setShadowNum(int num) {
        this.shadowNum = num;
    }
